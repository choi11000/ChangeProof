...
* **동결 일자**: 2026년 9월 4일
* **기준 브랜치**: `feature/public-deployment` (PR #6)
* **기준 커밋**: `90b1547` (또는 본 릴리즈 문서화 커밋)
...
* **공식 데모 PR**: [https://github.com/choi11000/changeproof-demo/pull/1](https://github.com/choi11000/changeproof-demo/pull/1)
* **검증된 데모 PR Head SHA**: `352a781b22e15d8f6f595b128795ad1829285093`
* **예상되는 정상 동작 결과**:
  * 변경 팩트: `DROP_COLUMN orders.legacy_status`
  * 의존성 증거: `app/order_service.py:11` (직접 참조)
  * AI 가설: `legacy_status 컬럼 삭제 시 애플리케이션 런타임 장애 발생 가능` (상태: `UNVERIFIED`)
